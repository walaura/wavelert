		...
		Focm: [
			function(require, module, exports) {
				...
				Object.defineProperty(exports, '__esModule', { value: !0 }),
					...
					(exports.withCloseWrapper = exports.promisified = void 0);
				var e = require('./src/WaveWindow'),
					r = require('./src/Dialog'),
					n = require('./src/Alert'),
					t = require('./src/Confirm');
				function o(e) {
				...
				var u = function(e) {
					return function() {
						return new Promise(function(r, n) {
							...
							document.body.appendChild(t), t.activate && t.activate();
						});
					};
				};
				exports.withCloseWrapper = u;
				var c = {
					Alert: function(r) {
					...
					Confirm: function(r) {
						...
						return u(function(r) {
							return (0, e.WaveWindow)(
								...
								(0, t.Confirm)(o({}, n, { onClose: r }))
							);
						});
					},
				};
				exports.promisified = c;
			},
			{
				'./src/WaveWindow': 'sKTG',
				'./src/Dialog': 'k0ZI',
...
//# sourceMappingURL=/wavelert/wavelert.6ca1910b.map
