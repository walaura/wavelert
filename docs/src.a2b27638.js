...
parcelRequire = (function(modules, cache, entry, globalName) {
...
})(
	{
		...
		'src/WaveWindow.js': [
					...
					var $title = createTitle({
						...
						onMove: function onMove(x, y) {
							...
							$window.style.transform = 'translateX('
								.concat(position[0], 'px) translateY(')
								.concat(position[1], 'px)');
						},
						onClose: onClose,
					});
					$window.prepend($title);
					var $wrapper = (0, _util.$element)(
						'div',
						{
			...
			{
				'../util': 'src/util.js',
				'./WaveWindow.css': 'src/WaveWindow.css',
				'../static/close.gif': 'src/static/close.gif',
			},
		],
		'src/Dialog.css': [
			function(require, module, exports) {
		...
		'src/static/glyph.css': [
			...
			{
				'./close.gif': [
					['close.0a726be5.gif', 'src/static/close.gif'],
					'src/static/close.gif',
				],
				'./alert.png': [
					['alert.6215773a.png', 'src/static/alert.png'],
		...
		'src/Dialog.js': [
			...
			{
				'../util': 'src/util.js',
				'./Dialog.css': 'src/Dialog.css',
				'../static/glyph.css': 'src/static/glyph.css',
			},
		],
		'src/Button.css': [
			function(require, module, exports) {
		...
		'src/Button.js': [
			...
			{ '../util': 'src/util.js', './Button.css': 'src/Button.css' },
		],
		'src/Alert.js': [
			function(require, module, exports) {
				'use strict';
			...
			{ './Dialog': 'src/Dialog.js', './Button': 'src/Button.js' },
		],
		'src/Confirm.js': [
			function(require, module, exports) {
				'use strict';
		...
		'src/index.js': [
				...
				var promisified = {
					Alert: function Alert(_ref) {
						...
						return withCloseWrapper(function(closeWrapper) {
							return (0, _WaveWindow.WaveWindow)(
								_objectSpread({}, props, {
			...
			{
				'./global/WaveWindow': 'src/WaveWindow.js',
				'./global/Dialog': 'src/Dialog.js',
				'./global/Alert': 'src/Alert.js',
				'./global/Confirm': 'src/Confirm.js',
			},
		],
	...
	{},
	['node_modules/parcel/src/builtins/hmr-runtime.js', 'src/index.js'],
	'wavelert'
);
